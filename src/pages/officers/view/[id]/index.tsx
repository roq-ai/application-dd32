...
import { getOfficerById } from 'apiSdk/officers';
...
function OfficerViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<OfficerInterface>(
    () => (id ? `/officers/${id}` : null),
    () =>
      getOfficerById(id, {
        relations: ['user'],
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('officer', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/officers/edit/${id}`} passHref legacyBehavior>
                    <Button
