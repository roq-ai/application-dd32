...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['undercover-agent', 'department-officer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Agents', path: '/agents', entity: 'agent', service: AccessServiceEnum.PROJECT, icon: FiShield },
    {
      name: 'Invitations',
      path: '/invitations',
      entity: 'invitation',
    ...
    { name: 'Officers', path: '/officers', entity: 'officer', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
    {
      name: 'Operations',
      path: '/operations',
      entity: 'operation',
