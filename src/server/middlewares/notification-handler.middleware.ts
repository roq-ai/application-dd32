...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'organization.update': {
    roles: ['department-officer', 'undercover-agent'],
    key: 'organization-updated',
    tenantPath: ['organization'],
    userPath: [],
  },
  'officer.delete': {
    roles: ['undercover-agent'],
    key: 'officer-left-organization',
    tenantPath: ['organization', 'user', 'officer'],
    userPath: [],
  },
};

const ownerRoles: string[] = ['undercover-agent'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['department-officer', 'undercover-agent'];
